...
#used to customize the form after init
...
class UserProfileForm(forms.ModelForm):
	...
	zip=forms.CharField(label="",widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Postal Zip'}),required=False)
	country=forms.CharField(label="",widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Country'}),required=False)
	class Meta:
		model=Profile()
		fields=( 'phone', 'address1', 'address1','address2', 'city', 'state', 'zip', 'country',)
